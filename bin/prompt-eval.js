...
Usage:
  prompt-eval run --target <brain|anthropic|http> [options]
...
Run options:
  --target <name>             brain | anthropic | http (required)
  ...
  --api-key <key>             Anthropic key (overrides ANTHROPIC_API_KEY) for anthropic target
  --model <name>              Anthropic target model
